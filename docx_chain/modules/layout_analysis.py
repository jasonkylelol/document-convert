...
sys.path.append(BASE_DIR + '/../doc_understanding/docx_layout')
from predictor import DocXLayoutInfo, DocXLayoutPredictor
...
class LayoutAnalysis(object):
    ...
    def __init__(self, configs):
        ...
        if configs['from_modelscope_flag'] is True:
            ...
            map_info = json.load(open(BASE_DIR + '/../doc_understanding/docx_layout/map_info.json'))
            category_map = {}
